...
def get_args_parser():
    ...
    parser.add_argument('--used_data_size', default = 1, help = 'the proportion of pairs you want to use')
    parser.add_argument('--update_epochs', default = 100, help = 'update epochs for each call to PMF train')
    parser.add_argument('--epochs', default = 100, help = 'epochs for gossip learning')
